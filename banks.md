...
Кроме того, банку нужно будет сообщить немецкий [налоговый идентификационный номер](taxes.md), но это не требуется для открытия счёта — когда получите номер, пришлите копию документа о его присвоении в банк.
...
Обычно для получения кредитной карты вы должны подписать мандат на автоматическое списание задолженности по ней раз в месяц с вашего текущего счёта. Кроме того, нужно дать разрешение на проверку вашей [кредитной истории](schufa.md) для предоставления кредитного лимита.
