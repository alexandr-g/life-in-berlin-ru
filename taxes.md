...
Идентификационный номер (**Identifikationsnummer**) выдаётся автоматически после первой [регистрации места жительства](Регистрация места жительства.md) в Германии. Документ о присвоении номера присылают по почте на указанный адрес проживания через несколько дней после регистрации.
...
В отличие от регистрации места жительства, **Finanzamt** (офис налогового ведомства) вас обслужит только **по месту жительства**. Узнать, к какому финанцамту вы относитесь, можно на [официальном сайте](https://www.berlin.de/sen/finanzen/steuern/finanzaemter/) — нужно ввести свой почтовый индекс.

## Калькулятор налогов и сборов

[Калькулятор зарплаты](http://www.brutto-netto-rechner.info/gehalt/gross_net_calculator_germany.php) после вычета налогов и страховых взносов (netto) на основании суммы зарплаты, которая указывается в контракте (brutto, gross salary). Размер дополнительного взноса за [медицинское страхование](Медицинское страхование.md) (HI add on) варьируется от кассы к кассе, для ТК в 2016 году он составляет 1,0%.
...
* Составить декларацию самостоятельно при помощи бесплатной программы **[ElsterFormular](https://www.elster.de/elfo_home.php)**. Некоторые пояснения на английском: http://www.toytowngermany.com/wiki/ELSTER
* Заполнить бумажную форму: [PDF](https://www.formulare-bfinv.de/ffw/catalog/openFolder.do?path=catalog%3A%2F%2FSteuerformulare%2Fest).
...
* Если вы приехали один, а на родине временно остались ваши жена, нетрудоспособные дети, родители с малыми доходами, которых вы финансово поддерживали, это тоже может быть вам выгодно в налоговом смысле. [Информация](files/parentstaxreturn.doc) о возврате налогов за помощь родителям.
